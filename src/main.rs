...
use crate::commands::{
    asm::*, asmdoc::*, block::*, botinfo::*, compile::*, compilers::*, cpp::*, execute::*,
...
#[group]
#[commands(
    botinfo, compile, execute, languages, compilers, libraries, ping, help, asm, asmdoc, block,
    unblock, invite, cpp, formats, format, insights
)]
struct General;
