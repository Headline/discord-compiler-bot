use crate::boilerplate::{
    c::CGenerator, cpp::CppGenerator, csharp::CSharpGenerator, dart::DartGenerator,
    java::JavaGenerator, php::PHPGenerator, sourcepawn::SourcePawnGenerator,
};
...
pub fn boilerplate_factory(language: &str, code: &str) -> BoilerPlate<dyn BoilerPlateGenerator> {
    match language {
        ...
        "dart" => BoilerPlate::new(Box::new(DartGenerator::new(code))),
        "sourcepawn" => BoilerPlate::new(Box::new(SourcePawnGenerator::new(code))),
